...
import com.anno.config.KafkaProperties;
...
@RestController
@RequestMapping("/api/annocash-kafka")
public class AnnocashKafkaResource {

    private final Logger log = LoggerFactory.getLogger(AnnocashKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public AnnocashKafkaResource(KafkaProperties kafkaProperties) {
